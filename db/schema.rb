...
ActiveRecord::Schema.define(version: 20170816211721) do

  create_table "cama_comments", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "author"
  ...
  create_table "cama_custom_fields", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "cama_metas", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string  "key"
    t.text    "value",        limit: 4294967295
    t.integer "objectid"
    t.string  "object_class"
  ...
  create_table "cama_term_relationships", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "objectid"
    t.integer "term_order"
  ...
  create_table "cama_term_taxonomy", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "taxonomy"
  ...
  create_table "cama_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "username"
